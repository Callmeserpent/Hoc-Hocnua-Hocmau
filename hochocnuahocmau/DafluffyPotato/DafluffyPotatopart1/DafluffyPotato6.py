...
pygame.display.set_caption('DaFluffyPotato Course7')
...
#load images
animation_database = {}
animation_database['run'] = load_animation('C:/Users/DELL/vscodeproject/hochocnuahocmau/DafluffyPotato/DafluffyPotatopart1/data/images/entities/player/run',[7,7])
animation_database['idle'] = load_animation('C:/Users/DELL/vscodeproject/hochocnuahocmau/DafluffyPotato/DafluffyPotatopart1/data/images/entities/player/idle',[7,7,40])
...
grass_sounds = [
    (pygame.mixer.Sound(r'C:\Users\DELL\vscodeproject\hochocnuahocmau\DafluffyPotato\DafluffyPotatopart1\data\audio\grass_0.wav')), 
    (pygame.mixer.Sound(r'C:\Users\DELL\vscodeproject\hochocnuahocmau\DafluffyPotato\DafluffyPotatopart1\data\audio\grass_1.wav'))]
...
while True: 
    ...
    tile_rects = []
    #tile rendering
    for y in range(3):       #caculate the chunk id that visible on screen
      for x in range(4):
